...
public class GameSetupTests {
	...
	public void testPeopleConfig() {
		...
		assertEquals(board.getPlayers().get(4).getName(), "Rev. Green");
		
		assertEquals(board.getPlayers().get(0).getRow(), 25);
		assertEquals(board.getPlayers().get(4).getRow(), 0);
		
		assertEquals(board.getPlayers().get(0).getColumn(), 0);
		assertEquals(board.getPlayers().get(4).getColumn(), 25);
		
		assertEquals(board.getPlayers().get(0).getColor(), Color.BLUE);
		assertEquals(board.getPlayers().get(4).getColor(), Color.GREEN);
	}
